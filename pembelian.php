                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="itemRows">
                                <tr>
                                    <td><input type="text" name="total_pembelian[]" class="form-control" maxlength="5"
                                            required></td>
                                    <td>
                                        <select class="form-select product-select" name="kode_barang[]" required>
                            ...
                            ?>
                                    ...
                                    <td><input type="text" name="harga_beli[]" class="form-control harga-beli" required>
                                    </td>
                    ...
                    if (kodeBarang) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                selectedRow.querySelector('.harga-beli').value = data.harga_beli;
                            }
                        });
                    } else {
                        selectedRow.querySelector('.harga-beli').value = '';
                    }
                }
            });

            $(document).ready(function() {
                $('#itemRows').on('change', 'select[id^="product"]', function() {
                    ...
                    if (kodeBarang) {
                        $.ajax({
                            ...
                            success: function(response) {
                                var data = JSON.parse(response);
                                selectedRow.find('input[id^="harga_beli"]').val(data
                                    .harga_beli);
                            }
                        });
                    } else {
                        selectedRow.find('input[id^="harga_beli"]').val('');
                    }
                });
            });
            </script>
